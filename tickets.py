...
def cli():
    ...
    options = [
        key[1] for key, value in arguments.items() if value is True
    ]
    # print(r.json())
...
class TrainsCollection:
    ...
    header = '车次 起点 终点 时间 历时 一等 二等 软卧 硬卧 硬座 无座'.split()
    ...
    @property
    def trains(self):
        for raw_train_org in self.available_trains:
            raw_train =raw_train_org['queryLeftNewDTO']
